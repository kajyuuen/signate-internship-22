...
class MyCatBoostModel:
    def __init__(self, name, params, category_cols, fold, metrics, seeds=None, log_path=None):
        self.name = name
        self.params = params
    ...
    def build_model(self):
        model = CatBoostClassifier(**dict(self.params))
        return model
    ...
    def predict_cv(self, train_x, train_y, importance_name=None):
        ...
        for seed in self.seeds:
            ...
            for cv_num, (tr_idx, va_idx) in enumerate(fold_idx):
                ...
                # predict - validation
                pred = model.predict(va_x, prediction_type='Probability')[:, 1]
                oof.append(pred)
    ...
    def inference(self, test_x, folds=5):
        ...
        for seed in self.seeds:
            ...
            for cv_num in range(folds):
                ...
                # predict - test data
                pred = model.predict(test_x_values, prediction_type='Probability')[:, 1]
                preds.append(pred)
